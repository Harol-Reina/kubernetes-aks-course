...
> *"Los contenedores revolucionaron el despliegue de aplicaciones al eliminar el overhead de sistemas operativos completos, permitiendo densidad masiva, arranque instantáneo y portabilidad verdadera entre ambientes."*
...
- Comprender qué es un contenedor y cómo difiere fundamentalmente de una VM
- Explicar los 4 pilares de Docker: Contenedores, Imágenes, Dockerfiles y Docker Hub
...
- Reconocer por qué los contenedores son la base de arquitecturas de microservicios

### 🛠️ Objetivos Técnicos
- Instalar Docker Engine en Linux, Windows y macOS
- Ejecutar contenedores desde imágenes públicas de Docker Hub
...
- Identificar y solucionar problemas de permisos y volúmenes
- Optimizar imágenes para reducir tamaño y mejorar performance
- Troubleshoot consumo excesivo de recursos (CPU, memoria, disco)

### 🏢 Objetivos Profesionales
- Justificar cuándo usar contenedores vs. VMs vs. serverless
- Implementar mejores prácticas de seguridad en imágenes Docker
- Diseñar estrategias de CI/CD con contenedores
- Prepararse conceptual y técnicamente para Kubernetes
...
- **Módulo 1 completado**: Fundamentos de virtualización (VMs, hipervisores)
- **Linux básico**: Comandos shell, gestión de procesos, filesystem
- **Redes**: Conceptos de IP, puertos, DNS
- **Desarrollo**: Familiaridad con al menos un lenguaje (Python, Node.js, Java, Go)

### 🛠️ Herramientas Necesarias
- **Docker Desktop**: [Instalar para Windows/Mac](https://www.docker.com/products/docker-desktop/)
- **Docker Engine**: [Instalar para Linux](https://docs.docker.com/engine/install/)
- **Editor de código**: VS Code (recomendado), Vim, nano
- **Cuenta Docker Hub**: [Crear cuenta gratuita](https://hub.docker.com/signup)
- **(Opcional) Git**: Para clonar repositorios de ejemplos
...
# Verificar que Docker Engine está corriendo
docker ps
# Debe retornar una tabla vacía (sin error)

# Verificar que puedes descargar imágenes
...
**💡 Si alguna verificación falla, revisa la [Guía de Instalación](./laboratorios/lab-01-instalacion-docker.md).**
...
- **Sección 1**: Evolución de modelos de despliegue - De VMs a contenedores (15 min)
- **Sección 2**: ¿Qué es la contenerización? - Definición técnica (20 min)
- **Sección 3**: Los 4 Pilares de Docker - Contenedores, Imágenes, Dockerfiles, Hub (30 min)
- **Sección 4**: Tecnologías subyacentes - Namespaces, cgroups, union FS (25 min)
- **Sección 5**: Arquitectura de Docker - Cliente, Engine, containerd, runc (20 min)
- **Sección 6**: Ecosistema de contenedores - Docker, Podman, CRI-O, containerd (15 min)
- **Sección 11**: Docker Compose - Orquestación multi-contenedor (20 min)
- **Sección 12**: Mejores prácticas - Seguridad, optimización, patrones (25 min)

### 🔬 Contenido Práctico (50%)
- **Sección 7**: Instalación de Docker - Linux, Windows, Mac (30 min)
- **Sección 8**: Primeros comandos - run, ps, logs, exec, stop, rm (40 min)
- **Sección 9**: Creación de imágenes - Dockerfile, build, push (50 min)
- **Sección 10**: Volúmenes y redes - Persistencia y comunicación (40 min)
- **Laboratorios guiados**: 5 labs prácticos hands-on
- **Proyecto integrador**: Aplicación web + base de datos con Docker Compose

### 📊 Distribución de Tiempo

| Actividad | Tiempo | Porcentaje |
|-----------|---------|------------|
| **Teoría y conceptos** | 2 horas 50 min | 50% |
| **Laboratorios prácticos** | 2 horas 40 min | 47% |
| **Proyecto final** | 10 minutos | 3% |
| **Total módulo** | **5 horas 40 min** | 100% |

**Nota**: Tiempos aproximados. Los laboratorios pueden extenderse según experiencia previa.

---

## 📚 Rutas de Estudio

### 🟢 Ruta Principiante (6-8 horas)
**Perfil**: Primera vez con contenedores, vienes del Módulo 1 de Virtualización.

**Recomendación de estudio**:
1. ✅ **Día 1 (3 horas)**: Leer secciones 1-6 completas (teoría de contenedores)
   - Enfocarse en entender diferencias VMs vs. contenedores
   - Tomar notas sobre los 4 pilares de Docker
   
2. ✅ **Día 2 (3 horas)**: Instalación + Laboratorios básicos
   - Instalar Docker (sección 7)
   - Completar Lab 1: Primeros comandos (run, ps, logs)
   - Completar Lab 2: Ejecutar aplicaciones (nginx, postgres, redis)

3. ✅ **Día 3 (2 horas)**: Crear tus propias imágenes
   - Estudiar Dockerfiles (sección 9)
   - Completar Lab 3: Dockerizar una aplicación Node.js
   - Subir imagen a Docker Hub

**🎯 Enfoque**: Solidez conceptual antes de práctica. No apresures los labs, es normal cometer errores.

**📌 Tips**:
- Usa Docker Desktop si estás en Windows/Mac (interfaz gráfica ayuda)
- Prueba cada comando múltiples veces para internalizarlo
- Consulta documentación oficial si algo no funciona: [docs.docker.com](https://docs.docker.com)

### 🟡 Ruta Intermedia (4-5 horas)
**Perfil**: Ya has usado Docker básicamente, quieres profundizar y formalizar conocimientos.

**Recomendación de estudio**:
1. ✅ **Sesión 1 (2 horas)**: 
   - Repasar secciones 3, 4, 5 (pilares, tecnologías, arquitectura)
   - Completar Lab 3: Dockerfile avanzado con multi-stage builds
   
2. ✅ **Sesión 2 (2 horas)**:
   - Sección 10: Volúmenes y redes en profundidad
   - Sección 11: Docker Compose
   - Lab 4: Aplicación multi-contenedor (web + DB + cache)

3. ✅ **Sesión 3 (1 hora)**:
   - Sección 12: Mejores prácticas y seguridad
   - Proyecto final: Stack completo con Docker Compose

**🎯 Enfoque**: Arquitecturas multi-contenedor, optimización, preparación para Kubernetes.

**📌 Tips**:
- Experimenta con diferentes estrategias de networking
- Practica optimización de imágenes (tamaño, capas, caching)
- Investiga Docker Buildx para builds multi-arquitectura

### 🔴 Ruta Certificación (3 horas)
**Perfil**: Preparándote para CKA/CKAD o trabajas con infraestructura cloud-native.

**Recomendación de estudio**:
1. ✅ **Sesión única (3 horas)**:
   - Revisar sección 4 (Namespaces, cgroups) - fundamental para Kubernetes
   - Sección 6: Ecosistema (containerd, CRI-O) - usado por Kubernetes
   - Labs rápidos con énfasis en troubleshooting
   - Resolver escenarios de debugging del RESUMEN

**🎯 Enfoque**: Entender Docker como runtime de Kubernetes, troubleshooting avanzado, seguridad.

**📌 Tips CKA/CKAD**:
- Kubernetes usa containerd (no Docker Engine) como runtime por defecto
- Practica `kubectl debug` que usa contenedores efímeros
- Entiende cómo funcionan los Container Runtime Interfaces (CRI)
- Memoriza troubleshooting de imágenes que no se pueden descargar
...
├── RESUMEN-MODULO.md                # 📝 Guía de estudio (comandos, troubleshooting)
├── laboratorios/
│   ├── lab-01-instalacion-docker.md       # 🧪 Instalar Docker en Linux/Windows/Mac
│   ├── lab-02-primeros-comandos.md        # 🧪 run, ps, logs, exec, stop, rm
│   ├── lab-03-dockerfile-nodejs.md        # 🧪 Dockerizar app Node.js
│   ├── lab-04-volumenes-redes.md          # 🧪 Persistencia y networking
│   └── lab-05-docker-compose.md           # 🧪 App multi-contenedor (web + DB)
├── ejemplos/
│   ├── dockerfile-examples/
│   │   ├── Dockerfile.nodejs            # ⚙️ Node.js + Express
│   │   ├── Dockerfile.python            # ⚙️ Python + Flask
│   │   ├── Dockerfile.java              # ⚙️ Java + Spring Boot
│   │   ├── Dockerfile.multi-stage       # ⚙️ Multi-stage build
│   │   └── Dockerfile.alpine            # ⚙️ Imagen mínima con Alpine
│   ├── docker-compose-examples/
│   │   ├── wordpress-mysql.yml          # ⚙️ WordPress + MySQL
│   │   ├── nginx-node-redis.yml         # ⚙️ Full stack con cache
│   │   └── monitoring-stack.yml         # ⚙️ Prometheus + Grafana
│   └── scripts/
│       ├── build-all.sh                 # 🔧 Build todas las imágenes
│       ├── cleanup-docker.sh            # 🔧 Limpiar recursos Docker
│       └── health-check.sh              # 🔧 Verificar salud de contenedores
└── assets/
    └── diagrams/
        ├── docker-architecture.svg      # 📊 Arquitectura completa
        ├── container-vs-vm.svg          # 📊 Comparativa visual
        └── dockerfile-layers.svg        # 📊 Capas de imágenes
```

### 📂 Descripción de Recursos

- **README.md**: Teoría completa, arquitectura, conceptos fundamentales
- **RESUMEN-MODULO.md**: Cheat sheet con comandos, troubleshooting, preguntas
- **laboratorios/**: 5 labs progresivos desde instalación hasta Compose
- **ejemplos/**: Dockerfiles reales, docker-compose.yml templates
- **assets/**: Diagramas arquitectónicos complementarios
...
- **50% Teoría**: Conceptos, arquitectura, tecnologías subyacentes
- **50% Práctica**: Labs hands-on, creación de imágenes, troubleshooting

### 🎓 Enfoque Pedagógico
Este módulo utiliza el método **"Concepto → Demostración → Práctica → Maestría"**:

1. **Fundamentos conceptuales** → Qué es un contenedor, por qué existe Docker
2. **Demostración guiada** → Ver comandos en acción con explicaciones
3. **Práctica supervisada** → Reproducir labs paso a paso
4. **Maestría autónoma** → Proyecto final sin guía detallada

### 🔄 Flujo de Trabajo Sugerido

```
📖 Leer teoría → 💻 Ver demo → 🧪 Lab guiado → 🔧 Ejercicio libre → 📝 RESUMEN
     ↓              ↓              ↓               ↓                ↓
  Conceptos     Visualización   Reproducción   Aplicación     Consolidación
```

**💡 Consejo**: Docker se aprende **haciendo**. Lee la teoría, pero dedica 60% del tiempo a ejecutar comandos.

### 🎬 Método de Laboratorio Recomendado

1. **Lee el objetivo del lab** → Entiende qué aprenderás
2. **Ejecuta cada comando** → No copies-pegues sin entender
3. **Experimenta variaciones** → Cambia parámetros, observa resultados
4. **Rompe cosas intencionalmente** → Aprende qué NO hacer
5. **Documenta tus errores** → Los errores enseñan más que los aciertos

---

## 🔗 Conexión con Otros Módulos

### ⬅️ Fundamentos desde módulos anteriores:
- **[Módulo 1: Virtualización](../modulo-1-virtualizacion/README.md)** - VMs, hipervisores, overhead de SO guest
  - **Conceptos clave**: Por qué las VMs tienen limitaciones que Docker resuelve

### ➡️ Este módulo prepara para:
- **[Área 2 - Módulo 1: Introducción a Kubernetes](../../area-2-arquitectura-kubernetes/modulo-01-introduccion-kubernetes/README.md)** - Orquestación de contenedores
  - **Conceptos clave**: Kubernetes orquesta contenedores Docker (o containerd)
  
- **[Área 2 - Módulo 4: Pods vs Contenedores](../../area-2-arquitectura-kubernetes/modulo-04-pods-vs-contenedores/README.md)** - Unidad mínima de Kubernetes
  - **Conceptos clave**: Un Pod puede contener uno o más contenedores

### 🌐 Contexto en el curso completo:

```
ÁREA 1: Fundamentos Docker
├── Módulo 1: Virtualización (VMs, overhead, limitaciones)
│   └── Por qué surgieron los contenedores
└── Módulo 2: Docker ← ESTÁS AQUÍ
    └── Contenedores como bloques básicos de K8s

            ↓

ÁREA 2: Arquitectura Kubernetes
├── Módulo 01: Introducción (Kubernetes orquesta contenedores)
├── Módulo 04: Pods (Agrupación de contenedores)
├── Módulo 05: Gestión de Pods (kubectl, ciclo de vida)
└── ... (18 módulos usando conceptos de Docker)
```

**🎯 Objetivo del módulo**: Dominar contenedores Docker para entender la base sobre la que Kubernetes opera.
...
│  ├──────────┤  ├──────────┤  ├──────────┤                  │
│  │ SO Guest │  │ SO Guest │  │ SO Guest │  ← SO Completo   │
│  │ (2-4 GB) │  │ (2-4 GB) │  │ (2-4 GB) │    por VM        │
│  └────┬─────┘  └────┬─────┘  └────┬─────┘                  │
│       └─────────────┼─────────────┘                         │
│                     │ HIPERVISOR │                          │
│  ┌──────────────────▼────────────────────────────┐          │
...
│                     │ Docker Engine │                       │
│  ┌──────────────────▼────────────────────────────────────┐  │
│  │    Sistema Operativo Host (Kernel compartido)        │  │
...
### 🔑 Términos Esenciales Docker

| Término | Definición Rápida |
|---------|-------------------|
| **Contenedor** | Instancia en ejecución de una imagen, proceso aislado |
| **Imagen** | Plantilla inmutable, snapshot del filesystem + metadata |
| **Dockerfile** | Archivo de texto con instrucciones para construir una imagen |
| **Docker Hub** | Registro público de imágenes (como GitHub para código) |
| **Layer (Capa)** | Cada instrucción del Dockerfile crea una capa inmutable |
| **Volume** | Directorio persistente fuera del filesystem del contenedor |
| **Network** | Red virtual que conecta contenedores entre sí |
| **Docker Compose** | Herramienta para definir apps multi-contenedor (YAML) |

### 📦 Los 4 Pilares de Docker (Vista Rápida)
...
#### 1. 🎓 Fundamentos Conceptuales Profundos
- ✅ Explicar qué es un contenedor a nivel de proceso Linux (no una "VM ligera")
- ✅ Describir cómo Docker usa namespaces (PID, NET, MNT, IPC, UTS) para aislamiento
- ✅ Comprender cómo cgroups limitan recursos (CPU, memoria, I/O)
- ✅ Entender union filesystems (OverlayFS, AUFS) y el sistema de capas
- ✅ Diferenciar Docker Engine, containerd, runc y su rol en la arquitectura

#### 2. 🛠️ Habilidades Técnicas Operacionales
- ✅ Instalar y configurar Docker en Linux (apt/yum), Windows, macOS
- ✅ Ejecutar contenedores con opciones avanzadas: `-p`, `-v`, `-e`, `--network`, `--rm`
- ✅ Crear Dockerfiles optimizados con multi-stage builds para reducir tamaño
- ✅ Construir imágenes con `docker build`, tagearlas y subirlas a Docker Hub
- ✅ Gestionar volúmenes (bind mounts, named volumes) para persistencia
- ✅ Configurar redes Docker (bridge, host, overlay, macvlan)
- ✅ Orquestar stacks multi-contenedor con Docker Compose (YAML)
- ✅ Implementar health checks y restart policies para resiliencia

#### 3. 🔍 Capacidades de Troubleshooting Avanzado
- ✅ Diagnosticar por qué un contenedor no arranca (`docker logs`, `docker inspect`)
- ✅ Ejecutar comandos dentro de contenedores en ejecución (`docker exec -it`)
- ✅ Resolver problemas de networking (DNS, conectividad entre contenedores)
- ✅ Identificar problemas de permisos en volúmenes (UID/GID mismatches)
- ✅ Optimizar imágenes grandes (identificar capas pesadas, usar Alpine)
- ✅ Limpiar recursos huérfanos (`docker system prune`, disk space)
- ✅ Debuggear builds fallidos (errores en Dockerfile, dependencias faltantes)

#### 4. 🏢 Visión Profesional y Mejores Prácticas
- ✅ Implementar seguridad: imágenes mínimas, no usar root, scanning de vulnerabilidades
- ✅ Optimizar Dockerfiles: ordenar instrucciones, aprovechar caching, minimizar capas
- ✅ Diseñar estrategias de CI/CD con builds automatizados y registries privados
- ✅ Justificar arquitectónicamente: microservicios con contenedores vs. monolitos
- ✅ Prepararte conceptualmente para Kubernetes (Pods, Services, Deployments)
- ✅ Comprender el ecosistema: Docker vs. Podman vs. containerd vs. CRI-O

---

**Duración estimada**: 6-8 horas (principiante) | 4-5 horas (intermedio) | 3 horas (certificación)  
