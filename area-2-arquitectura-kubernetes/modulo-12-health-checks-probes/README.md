# Módulo 12: Health Checks y Probes en Kubernetes

> **Verificaciones de Salud para Alta Disponibilidad**  
> Aprende a configurar Startup, Liveness y Readiness Probes para garantizar la disponibilidad y auto-recuperación de tus aplicaciones.
...
### 🎯 Fundamentos
- Comprender qué son las probes y por qué son críticas
- Diferenciar entre **Startup**, **Liveness** y **Readiness** probes
- Explicar el ciclo de vida de un Pod y cuándo se ejecutan las probes
- Identificar cuándo usar cada tipo de probe

### 🔧 Técnicos
- Configurar HTTP, TCP y Exec probes
- Ajustar parámetros (initialDelaySeconds, periodSeconds, timeoutSeconds)
- Combinar múltiples probes efectivamente
- Usar named ports en probes
- Diagnosticar fallos de probes con `kubectl describe`

### 🚀 Avanzados
- Diseñar endpoints de health check en aplicaciones
...
### 💼 Profesionales
- Establecer políticas de probes por tipo de aplicación
- Balancear disponibilidad vs sensibilidad en producción
...
kubectl create namespace health-checks-demo
```
...
|---------|------|----------|------|
| **1** | Introducción y ciclo de vida del Pod | 20 min | 📖 Teoría |
| **2** | Startup Probe (aplicaciones lentas) | 30 min | 📖 Teoría |
| **3** | Liveness Probe (detección de fallos) | 30 min | 📖 Teoría |
| **4** | Readiness Probe (gestión de tráfico) | 30 min | 📖 Teoría |
| **Lab 1** | [Probes Básico](laboratorios/lab-01-probes-basico.md) | 45 min | 🧪 Laboratorio |
| **5** | Tipos de verificaciones (HTTP, TCP, Exec) | 30 min | 📖 Teoría |
| **6** | Parámetros de configuración | 20 min | 💻 Práctica |
| **Lab 2** | [Startup Avanzado](laboratorios/lab-02-startup-avanzado.md) | 50 min | 🧪 Laboratorio |
| **7** | Probes combinadas y named ports | 20 min | 📖 Teoría |
| **8** | Best practices | 30 min | 📖 Teoría |
| **9** | Troubleshooting | 30 min | 📖 Teoría |
| **Lab 3** | [Troubleshooting](laboratorios/lab-03-troubleshooting.md) | 60 min | 🧪 Laboratorio |
| **10** | Ejemplos por tecnología | 20 min | 💻 Práctica |
| | **TOTAL** | **5.5 horas** | |
...
**Para developers que comienzan con health checks**

**Día 1**: Fundamentos
- Estudiar secciones 1-4 (ciclo de vida, 3 tipos de probes)
- Entender cuándo usar cada probe
- Explorar ejemplos básicos en `ejemplos/01-liveness/`, `ejemplos/02-readiness/`
- **Lab 1**: Probes Básico (45 min)

**Día 2**: Configuración
- Sección 5-6 (tipos de verificaciones, parámetros)
- Experimentar con HTTP, TCP y Exec probes
- Ajustar timeouts y delays
- **Lab 2**: Startup Avanzado (50 min)

**Día 3**: Producción
- Sección 7-9 (combinadas, best practices, troubleshooting)
- **Lab 3**: Troubleshooting (60 min)
- Revisar [RESUMEN-MODULO.md](RESUMEN-MODULO.md)
- Aplicar probes a 1-2 apps propias

---

### 🟡 Ruta Intermedia (1-2 días)
**Para quienes ya usan probes básicamente**

**Día 1**: Profundización
- Repasar diferencias entre Liveness vs Readiness
- Enfocarse en Startup probe (sección 2)
- Explorar ejemplos combinados en `ejemplos/04-combinados/`
- **Lab 1 y Lab 2** (95 min total)

**Día 2**: Optimización
- Sección 8-9 (best practices, troubleshooting)
- Ejemplos por tecnología (Node.js, Java, Python)
- **Lab 3**: Troubleshooting (60 min)
- Auditar probes de aplicaciones existentes
...
- Memorizar sintaxis de los 3 tipos de probes
- Dominar parámetros clave (initialDelaySeconds, failureThreshold)
- Practicar: crear probes sin mirar documentación (1 hora)

**Tarde (2 horas)**:
- 🧪 **Los 3 laboratorios** en time-boxing estricto
- ⚠️ Troubleshooting: diagnosticar por qué un Pod no está ready
- 📊 Practicar `kubectl describe pod` para ver eventos de probes
- 🎯 Escenarios: agregar probes a Deployments existentes (<5 min)

**Temas críticos para examen**:
- Configurar liveness y readiness probes rápidamente
- Diagnosticar por qué un Pod está en CrashLoopBackOff (liveness fallando)
- Identificar por qué un Service no tiene endpoints (readiness fallando)
- Ajustar initialDelaySeconds para apps lentas
...
│   ├── 01-liveness/                   # Liveness probe básica
│   ├── 02-readiness/                  # Readiness probe básica
│   ├── 03-startup/                    # Startup probe (apps lentas)
│   ├── 04-combinados/                 # Las 3 probes combinadas
│   ├── 05-http/                       # HTTP GET probes
│   ├── 06-tcp/                        # TCP Socket probes
│   └── 07-exec/                       # Exec command probes
└── laboratorios/                      # 3 labs prácticos guiados
    ├── lab-01-probes-basico.md        # 45 min - Fundamentos
    ├── lab-02-startup-avanzado.md     # 50 min - Apps lentas
    └── lab-03-troubleshooting.md      # 60 min - Diagnóstico
```
