...
> **Gestión de Versiones y Despliegues Sin Downtime**: Rolling updates, rollbacks, y estrategias de despliegue en producción.
...
- **Entender Deployments**: Capa de abstracción sobre ReplicaSets
- **Arquitectura jerárquica**: Deployment → ReplicaSet → Pods
- **Rolling updates**: Actualizar versiones sin downtime
- **Rollback automático**: Volver a versión anterior en segundos
- **Estrategias de despliegue**: RollingUpdate, Recreate, Blue/Green, Canary
- **Reconciliation loop**: Cómo Deployment gestiona ReplicaSets

### 🛠️ Objetivos Técnicos
- **Crear Deployments**: Manifiestos YAML production-ready
- **Rolling updates**: kubectl set image, apply con nueva versión
...
- **Rollout stuck**: Por qué no progresa el despliegue
- **Revisar historial**: Qué cambió entre revisiones
- **Analizar eventos**: Deployment controller logs
- **Verificar progreso**: kubectl rollout status

### 🏢 Objetivos Profesionales
- **Zero-downtime deployments**: Actualizaciones sin interrupción
- **Producción estándar**: Deployments son el estándar (no ReplicaSets)
- **CI/CD integration**: Automatizar despliegues
- **Rollback strategy**: Plan B siempre listo
- **Preparación CKA/CKAD**: 25-30% del examen
...
- ✅ **Módulos 04-06 completados**: Pods, gestión, ReplicaSets
- ✅ **Versionado de imágenes**: Docker tags (latest, v1.0, sha256)
- ✅ **Conceptos de CI/CD**: Pipeline básico
- ✅ **Health checks**: Liveness y readiness probes

### Herramientas Necesarias
- 🔧 **Minikube activo**: Cluster funcionando
- 🔧 **kubectl configurado**: Con autocompletado
- 🔧 **Recursos suficientes**: Para soportar rolling update (2x réplicas temporalmente)
...
# Verificar recursos (debe soportar 6-8 Pods temporalmente)
kubectl describe node minikube | grep -A 5 "Allocated resources"

# Probar creación de Deployment
kubectl create deployment test --image=nginx:1.21 --replicas=3
...
1. **Introducción a Deployments** (20 min) - Arquitectura
2. **Rolling Updates** (25 min) - Cómo funcionan internamente
3. **Estrategias de Despliegue** (25 min) - RollingUpdate, Recreate, etc.
4. **Rollback y Historial** (20 min) - Volver atrás

### Contenido Práctico (180-240 minutos)
1. **Crear Deployments** (30 min) - YAML básico
2. **Rolling update manual** (40 min) - Cambiar imagen
3. **Controlar rollout** (30 min) - maxSurge, maxUnavailable
4. **Rollback** (30 min) - Deshacer cambios
5. **Estrategias avanzadas** (40 min) - Canary, Blue/Green
6. **Troubleshooting** (30 min) - Rollouts fallidos
7. **Proyecto final** (30 min) - CI/CD simulation

### Ejemplos Prácticos
- 📁 **01-deployment-basico/** - Primera versión
- 📁 **02-rolling-update/** - Actualización gradual
- 📁 **03-rollback/** - Volver a versión anterior
- 📁 **04-strategies/** - RollingUpdate vs Recreate
- 📁 **05-control-speed/** - maxSurge, maxUnavailable
- 📁 **06-pause-resume/** - Control manual
- 📁 **07-canary-deployment/** - Despliegue canario
- 📁 **08-blue-green/** - Cambio instantáneo
- 📁 **09-troubleshooting/** - Diagnóstico
- 📁 **10-cicd-simulation/** - Pipeline completo

### Laboratorios
- 🔬 **Lab 01**: Crear Deployment con 3 réplicas
- 🔬 **Lab 02**: Rolling update de v1.21 a v1.22
- 🔬 **Lab 03**: Rollback a versión anterior
- 🔬 **Lab 04**: Controlar velocidad de rollout
- 🔬 **Lab 05**: Implementar Canary deployment
- 🔬 **Lab 06**: Troubleshooting rollout fallido
- 🔬 **Lab 07**: Pipeline CI/CD completo
- 🔬 **Lab 08**: Proyecto production-ready
...
Día 1: Fundamentos (3 horas)
  ├─ Teoría: Deployments (40 min)
  ├─ Lab 01: Primer Deployment (40 min)
  ├─ Teoría: Rolling updates (40 min)
  └─ Lab 02: Update v1.21 → v1.22 (60 min)

Día 2: Rollback y Control (3 horas)
  ├─ Teoría: Rollback (30 min)
  ├─ Lab 03: Undo rollout (30 min)
  ├─ Lab 04: maxSurge/maxUnavailable (60 min)
  └─ Lab 05: Canary deployment (60 min)

Día 3: Avanzado (2 horas)
  ├─ Lab 06: Troubleshooting (40 min)
  ├─ Lab 07: CI/CD simulation (60 min)
  └─ RESUMEN-MODULO.md (20 min)
```

### 🟡 Ruta Intermedia
**Tiempo**: 3-4 horas
```
Sesión 1: Teoría + Básico (90 min)
  ├─ Teoría concentrada (45 min)
  └─ Labs 01-03 (create, update, rollback) (45 min)

Sesión 2: Avanzado (2 horas)
  ├─ Lab 04: Control speed (30 min)
  ├─ Lab 05: Canary (45 min)
  ├─ Lab 06: Troubleshooting (30 min)
  └─ RESUMEN-MODULO.md (15 min)
```
...
Estrategia Examen:
  ...
  │   ├─ kubectl create deployment (5 min)
  │   ├─ kubectl set image (10 min)
  │   ├─ kubectl rollout status (5 min)
  │   ├─ kubectl rollout undo (10 min)
  │   ├─ kubectl rollout history (5 min)
  │   ├─ Editar strategy (10 min)
  │   └─ Deployment completo YAML (15 min)
  │
  └─ Memorización (10 min)
...
CKA: 20% (Workloads & Scheduling)
CKAD: 30% (Application Deployment)
```
...
```
ejemplos/
├── 01-deployment-basico/
│   ├── README.md
│   ├── deployment-nginx.yaml       # 3 réplicas nginx:1.21
│   └── commands.md                 # kubectl get deploy,rs,pods
│
├── 02-rolling-update/
│   ├── README.md
│   ├── update-imperative.sh        # kubectl set image
│   ├── update-declarative.yaml     # nginx:1.22
│   └── watch-rollout.sh            # Ver progreso
│
├── 03-rollback/
│   ├── README.md
│   ├── rollout-undo.sh             # Deshacer último
│   └── rollout-to-revision.sh      # Volver a rev N
│
├── 04-strategies/
│   ├── README.md
│   ├── strategy-rollingupdate.yaml # Default
│   └── strategy-recreate.yaml      # Kill all, create all
│
├── 05-control-speed/
│   ├── README.md
│   ├── maxsurge-example.yaml       # 50% surge
│   └── maxunavailable-example.yaml # 0% unavailable
│
├── 06-pause-resume/
│   ├── README.md
│   ├── pause-rollout.sh            # kubectl rollout pause
│   └── resume-rollout.sh           # kubectl rollout resume
│
├── 07-canary-deployment/
│   ├── README.md
│   ├── canary-step1.yaml           # 10% tráfico v2
│   ├── canary-step2.yaml           # 50% tráfico v2
│   └── canary-step3.yaml           # 100% tráfico v2
│
├── 08-blue-green/
│   ├── README.md
│   ├── deployment-blue.yaml        # Versión actual
│   ├── deployment-green.yaml       # Versión nueva
│   └── switch-service.yaml         # Cambiar selector
│
├── 09-troubleshooting/
│   ├── README.md
│   ├── rollout-stuck.yaml          # ImagePullBackOff
│   ├── diagnose-commands.md        # Troubleshooting
│   └── events-analysis.md          # Interpretar eventos
│
└── 10-cicd-simulation/
    ├── README.md
    ├── pipeline-steps.sh           # Build → Test → Deploy
    ├── deployment-dev.yaml         # Dev environment
    └── deployment-prod.yaml        # Prod con controls
```
...
Este módulo es **35% teórico, 65% práctico**:

### Distribución de Contenido
```
💻 Práctica rollouts       50%  ██████████▓░░░░░░░░░
📖 Teoría y estrategias    25%  █████▓░░░░░░░░░░░░░░
🔍 Troubleshooting         15%  ███▓░░░░░░░░░░░░░░░░
🎯 CI/CD simulation        10%  ██▓░░░░░░░░░░░░░░░░░
```

### Enfoque Pedagógico
1. **Experimentación controlada**: Update → observar → rollback
2. **Visualización**: Watch rollout en tiempo real
3. **Fail fast**: Romper rollouts para aprender troubleshooting
4. **Production mindset**: Todos los ejercicios con zero-downtime

### Flujo de Trabajo
```
1. Deploy v1 → 2. Verificar running → 3. Update a v2 → 4. Watch rollout
                ↓
5. Verificar v2 → 6. Simular problema → 7. Rollback a v1 → 8. Verificar
```
...
- ➡️ **Módulo 08**: Services (balanceo durante rollouts)
- ➡️ **Módulo 09**: Ingress (routing Blue/Green)
- ➡️ **Módulo 12**: Health Checks (readiness durante updates)
- ➡️ **Área 3**: CI/CD pipelines en producción

### Relación con Módulos Anteriores
```
Módulo 05: Gestión de 1 Pod
    ↓
Módulo 06: Gestión de N Pods (ReplicaSet)
    ↓
Módulo 07: Gestión de versiones de N Pods ← ESTÁS AQUÍ
```

---

## 💡 Concepto Clave: Rolling Update

**Actualización gradual sin downtime**

```
ANTES (v1.21):              DURANTE UPDATE:              DESPUÉS (v1.22):
┌─────────────┐             ┌─────────────┐             ┌─────────────┐
│ RS-OLD      │             │ RS-OLD      │             │ RS-OLD      │
│ 3 Pods v1.21│             │ 1 Pod v1.21 │             │ 0 Pods      │
└─────────────┘             └─────────────┘             └─────────────┘
                            ┌─────────────┐             ┌─────────────┐
                            │ RS-NEW      │             │ RS-NEW      │
                            │ 2 Pods v1.22│             │ 3 Pods v1.22│
                            └─────────────┘             └─────────────┘
```

**Proceso**:
1. Crea nuevo ReplicaSet (RS-NEW) con 0 réplicas
2. Scale up RS-NEW: 0 → 1 (espera readiness)
3. Scale down RS-OLD: 3 → 2
4. Repite hasta RS-NEW = 3, RS-OLD = 0
5. RS-OLD queda con 0 réplicas (se conserva para rollback)
...
- ✅ **Comprender arquitectura Deployment** → ReplicaSet → Pod
- ✅ **Crear Deployments** con manifiestos YAML production-ready
- ✅ **Ejecutar rolling updates** sin downtime
- ✅ **Controlar velocidad de rollout** con maxSurge y maxUnavailable
- ✅ **Pausar y resumir** despliegues para validación
- ✅ **Hacer rollback** a versiones anteriores instantáneamente
- ✅ **Implementar estrategias avanzadas**: Canary, Blue/Green
- ✅ **Troubleshooting rollouts** fallidos o stuck
- ✅ **Integrar con CI/CD**: Automatizar despliegues
- ✅ **Aplicar best practices** de despliegues en producción
- ✅ Crear Deployments usando manifiestos YAML
- ✅ Actualizar aplicaciones con rolling updates automáticos
- ✅ Realizar rollbacks a versiones anteriores
- ✅ Escalar Deployments horizontal
- ✅ Inspeccionar estado y historial de revisiones

### **Operaciones Avanzadas**
- ✅ Configurar estrategias de despliegue (RollingUpdate, Recreate)
- ✅ Ajustar parámetros: maxSurge, maxUnavailable
- ✅ Implementar Blue-Green deployments
- ✅ Implementar Canary deployments
- ✅ Pausar y reanudar deployments para cambios batch
- ✅ Gestionar historial de revisiones y change causes

### **Best Practices de Producción**
- ✅ Aplicar naming conventions y labels consistentes
- ✅ Definir resources, limits y health checks
- ✅ Configurar readiness/liveness probes correctamente
- ✅ Implementar security contexts
- ✅ Crear templates production-ready
...
Debes dominar estos conceptos del **Módulo 06**:

| Concepto | Por qué es importante |
|----------|----------------------|
| **ReplicaSets** | Deployments gestionan ReplicaSets internamente |
| **Auto-recuperación** | Deployment hereda self-healing de ReplicaSets |
| **Selectors y Labels** | Críticos para identificar Pods gestionados |
| **Limitaciones de ReplicaSets** | Justifican por qué necesitamos Deployments |
| **Escalado horizontal** | Deployment también escala (pero mejor) |

**⚠️ Importante**: Si no has completado el Módulo 06, **hazlo primero**. Deployments son una capa de abstracción sobre ReplicaSets.
